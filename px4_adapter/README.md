# SafeDrones → PX4 Adapter

隔离的 PX4 SITL/Gazebo/ROS 2 接入层。它不修改 `mock_drone.py`、MARL 策略或
高层 Safety Gate，只负责 SafeDrones 任务级 MQTT 意图与 PX4 飞控之间的本地
安全边界。
...
python3 -m unittest discover -s px4_adapter/tests -v
```
