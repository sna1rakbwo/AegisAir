...
RECOVERY_SYSTEM_PROMPT = (
    ...
    "takes over the failed drone's task. "
    ...
    "goal progress), break the deadlock with action REROUTE (and optionally "
    "YIELD) so the affected drone takes a lateral detour; never emit velocity "
